...
class TestInference:
    ...
    #     self, architecture, dataset, model_name, get_fixt_UGRIZY_noZ
    # ):

    #     test_ds, y_test_ds = get_fixt_UGRIZY_noZ
    #     y_test = np.concatenate([y for y in y_test_ds], axis=0)
    ...
    #     ),
    # )
    # def test_inference_GR_noZ(self, architecture, dataset, model_name, get_fixt_GR_noZ):

    #     test_ds, y_test_ds = get_fixt_GR_noZ
    #     y_test = np.concatenate([y for y in y_test_ds], axis=0)
    ...
    #     self, architecture, dataset, model_name, get_fixt_GR_noZ
    # ):
